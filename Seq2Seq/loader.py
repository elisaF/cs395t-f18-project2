...
def load_corpus(data_dir):
    ...
    """
    source_files = ["train_source.txt", "train_target.txt",
                    "valid_source.txt", "valid_target.txt"]
    ...
    return indexer, train_source, train_target, valid_source, valid_target
...
class DataIterator:
    ...
    def _pad_sentence(self, index, max_source_length, max_target_length):
        """Sentence padder.
        ...
        return source_padded, target_padded, source_length, target_length
    
    def random_batch(self, batch_size, max_source_length=20, max_target_length=20):
        ...
        for index in batch_indices:
            ...
            source_length, target_length = self._pad_sentence(index,
                                                              max_source_length, 
                                                              max_target_length)
